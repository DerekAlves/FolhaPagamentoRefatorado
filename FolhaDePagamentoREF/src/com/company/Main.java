...
//public static Stack<int> pilhaop = new Stack<int>();
        ...
        if(i != -1)
        {
            ...
            if(option == 1)
            {
                ...
                if(ListaFuncionarios.get(i).getTiponum() == 1)
                {
                    ...
                    ListaFuncionarios.get(i).setHj(ListaFuncionarios.get(i).getHj() + exc.loaddouble());
    ...
    private static void menu(int dia, ArrayList<Funcionario> ListaFuncionarios) {
        ...
        if (dia < 32) {
            ...
            else if(option == 11) printFunc(ListaFuncionarios, exc.loadint());
